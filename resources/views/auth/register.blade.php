          ...
          <div class="card-body ">
            ...
            <div class="bmd-form-group{{ $errors->has('number') ? ' has-danger' : '' }} mt-3">
              <div class="input-group">
                ...
                <input type="number" name="number" id="number" class="form-control" placeholder="{{ __('Number...') }}" required>
              </div>
              ...
              <div class="input-group">
                ...
                <input type="city" name="city" id="city" class="form-control" placeholder="{{ __('City...') }}" required>
              </div>
